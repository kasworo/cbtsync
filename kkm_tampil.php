			...
			<div class="table-responsive">
				...
				<tr>
					...
					while($l=$ql->fetch_array()){
						$qkkm=$conn->query("SELECT kkm FROM tbkkm WHERE idmapel='$m[idmapel]' AND idkelas='$l[idkelas]' AND idthpel='$idthpel'");
						$k=$qkkm->fetch_array();
						if($k['kkm']==0 || $k['kkm']==null) {$kkm='';} else {$kkm=$k['kkm'];}
					?>
					<td style="text-align: center;">
					 
					<input class="form-control form-control-sm form-control-sm-4 ekkm" data-id="<?php echo $m['idmapel'].'&kls='.$l['idkelas'];?>" style="text-align:center" value="<?php echo $kkm;?>">
					</td>
				<?php } ?>
				</tr>
				<?php } ?>
