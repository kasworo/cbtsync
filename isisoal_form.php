			...
			<div class="modal-body">
				...
				?>
					<div class="col-sm-12">
						...
						<div class="form-group row mb-2">
							<textarea class="form-control form-control-sm opsi" name="opsijwb" id="opsijwb" style="font-size:14pt;padding:5px"><?php echo $ops['opsi'];?></textarea> 
						</div>
						<label><?php echo $judul2;?></label>
						<div class="form-group row mb-2">
							<textarea class="form-control form-control-sm opsi" name="opsijwbalt" id="opsijwbalt" style="font-size:14pt; padding:5px"><?php echo $ops['opsialt'];?></textarea> 
						</div>
					</div>
				...
				<?php else:?>
					<div class="col-sm-12">
						...
						<div class="form-group row mb-2">
							<textarea class="form-control form-control-sm opsi" name="opsijwb" id="opsijwb"><?php echo $ops['opsi'];?></textarea>
						</div>
					</div>
				<?php endif?>
				</div>
...
<div class="col-sm-12">
	<div class="card card-danger card-outline">
		<div class="card-header">
			<h3 class="card-title col-sm-6"><strong>Edit Butir Soal <?php echo $nmbank;?> (Nomor <?php echo $maks;?>)</strong></h3>
			<div class="card-tools col-sm-6">
				<button title="Tambah Opsi Jawaban" class="btn btn-info btn-sm col-sm-2 ml-1 mb-2 float-right" id="addopsi" data-toggle="modal" data-target="#myAddOpsi">
					<i class="fas fa-plus-circle"></i> Opsi
				</button>
				<button title="Update Butir Soal" type="submit" class="btn btn-success btn-sm col-sm-2 ml-1 mb-2 float-right" id="savesoal">
					<i class="fas fa-save"></i> Update
				</button>
				<button title="Upload File Pendukung" type="submit" class="btn btn-secondary btn-sm col-sm-2 ml-1 mb-2 float-right" id="upload">
		...
		<div class="card-body">
			<div class="col-sm-12">
				<div class="form-group row mb-2">
						...
						<div class="form-group row mb-2">
							...
							<div class="col-sm-6">
								...
								<select id="kategori" name="kategori" class="form-control form-control-sm">
									...
									<option value="1" <?php echo $j1;?> title="Pilihan Ganda 1 Jawaban Benar">Pilihan Ganda Biasa</option>
									<option value="2" <?php echo $j2;?> title="Pilihan Ganda > 1 Jawaban Benar">Pilih Ganda Kompleks</option>
					...
					<div class="col-sm-6">
						...
						<div class="form-group row mb-2">
							...
							<div class="col-sm-6">
								<input class="form-control form-control-sm" id="skormaks" name="skormaks" disabled="true" value="<?php echo $skormaks;?>">
							</div>
						</div>
					</div>					
				</div>
				...
				<div class="form-group row mb-2">
					<div class="col-sm-12">
						<textarea class="form-control form-control-sm" name="tanyasoal" id="tanyasoal" style="font-size:14pt; width:100%; height:200px;padding:5px"><?php echo $butirsoal;?></textarea> 
					</div>
				</div>
				<hr/>
				<?php if($modeopsi=='1'):?>
					...
					<div class="form-group row mb-3">
						<div class="col-sm-5">
							<input class="form-control form-control-sm" value="" id="header1">
						</div>
						<div class="col-sm-5">
							<input class="form-control form-control-sm" value="" id="header2">
						</div>
						<div class="col-sm-2">
							<button class="btn btn-outline-secondary btn-block col-sm-12" id="saveopsi<?php echo $i;?>">
								<i class="fas fa-save"></i>&nbsp;Simpan
							</button>
						</div>
					</div>
				...
				<div id="jawabopsi">
					...
					<div class="form-group row mb-2">
						...
						<div class="col-sm-7">
							...
							?>
								<select class="form-control form-control-sm col-sm-4 ml-2 mb-2" id="kunci<?php echo $i;?>" name="kunci">
									<option value="1" <?php echo $cek;?>>Ya</option>
									<option value="0" <?php echo $cek0;?>>Tidak</option>
								</select>
								<button class="btn btn-outline-secondary btn-sm col-sm-3 ml-2 mb-2" id="uplopsi<?php echo $i;?>">
									<i class="fas fa-image"></i>&nbsp;Upload
								</button>
								<button class="btn btn-outline-secondary btn-sm col-sm-2 ml-2 mb-2 mb-2" id="saveopsi<?php echo $i;?>">
									<i class="fas fa-save"></i>&nbsp;Update
								</button>
								<button class="btn btn-outline-secondary btn-sm col-sm-2 ml-2 mb-2 mb-2" id="delopsi<?php echo $i;?>">
					...
					<div class="form-group row mb-2">					
						<div class="col-sm-6">
							<textarea class="form-control form-control-sm opsi" name="opsijwb" id="opsijwb<?php echo $i;?>" style="font-size:14pt; width:100%; height:150px;padding:5px"><?php echo $ops['opsi'];?></textarea> 
						</div>
						<div class="col-sm-6">
							<textarea class="form-control form-control-sm opsi" name="opsijwbalt" id="opsijwbalt<?php echo $i;?>" style="font-size:14pt; width:100%; height:150px;padding:5px"><?php echo $ops['opsialt'];?></textarea> 
						</div>
					</div>
					<script type="text/javascript">
						$("#saveopsi<?php echo $i;?>").click(function(){							
							...
							$.ajax({
								...
								type:'POST',
								data:"aksi=2&id="+id+"&soal="+soal+"&ops="+encodeURIComponent(ops)+"&ops2="+encodeURIComponent(opsalt)+"&skr="+skor,
								success:function(data){
									toastr.success(data);
								}
							})
						})
						$("#delopsi<?php echo $i;?>").click(function(){
							var id="<?php echo $ops['idopsi'];?>";
							$.ajax({
								url:"isisoal_simpan.php",
								type:'POST',
					...
					<script type="text/javascript">
						$("#saveopsi<?php echo $i;?>").click(function(){
							...
							$.ajax({
								url:"isisoal_simpan.php",
								type:'POST',
								data:"aksi=2&id="+id+"&soal="+soal+"&ops="+encodeURIComponent(ops)+"&skr="+skor,
								success:function(data){
									toastr.success(data);
								}
							})
	...
	<script type="text/javascript">
		$("#saveopsi").click(function(){
			...
			$.ajax({
				url:"isisoal_simpan.php",
				type:'POST',
				data:"aksi=2&soal="+soal+"&ops="+encodeURIComponent(ops)+"&opsalt="+ encodeURIComponent(opsalt)+"&skr="+skor,
				success:function(data){
					toastr.success(data);
				}
			})
...
<script type="text/javascript">
	...
	$("#savesoal").click(function(){
		...
		$.ajax({
			url:"isisoal_simpan.php",
			type:'POST',
			data:"aksi=1&ib="+ib+"&id="+id+"&js="+js+"&tk="+tk+"&sk="+sk+"&nm="+nm+"&bt="+encodeURIComponent(bt),
			success:function(data){
