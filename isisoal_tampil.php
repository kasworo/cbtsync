            ...
            <div class="col-sm-12">
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <a href="index.php?p=editsoal&id=<?php echo $s['idbank'].'&nm='.$s['nomersoal'];?>"
                                    class="btn btn-xs btn-primary col-4">
                                    <i class="fas fa-edit"></i> Edit</a>
                                <button data-id="<?php echo $s['idbutir'];?>"
                                    class="btn btn-xs btn-danger col-4 btnHapus">
                ...
                <div class="form-group row mb-2">
                    <?php
						...
						$hd=$qhd->fetch_array();
						if($hd['header1']==NULL || $hd['header2']==NULL):
