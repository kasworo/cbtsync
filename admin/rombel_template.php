...
$sql = "SELECT s.nis, s.nisn,s.nmsiswa, rs.idrombel, rb.idthpel FROM tbpeserta s LEFT JOIN tbrombelsiswa rs ON rs.idsiswa=s.idsiswa LEFT JOIN tbrombel rb ON rb.idrombel=rs.idrombel LEFT JOIN tbthpel th ON th.idthpel=rb.idthpel WHERE s.deleted='0'";
// var_dump($sql);
// die;
$ceksiswa = cquery($sql);
if ($ceksiswa > 0) {
