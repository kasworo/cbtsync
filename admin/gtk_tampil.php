...
<div class="card card-secondary card-outline">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="index.php?p=addgtk" class="btn btn-primary btn-sm">
				<i class="fas fa-plus-circle"></i>&nbsp;Tambah
			</a>
			<button class="btn btn-success btn-sm" id="btnAkun">
				<i class="far fa-check-square"></i>&nbsp;Aktivasi Akun
			</button>
			<button class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#myImportguru">
